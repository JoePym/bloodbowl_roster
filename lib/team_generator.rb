class TeamGenerator
  ...
  def generate
    @pdf.image "#{Rails.root}/app/assets/images/#{@team.roster.logo_path}", :at => [0, @pdf.bounds.height], :height => 75
    ...
    team_details = [
      ...
      ["Rerolls (#{@team.roster.reroll_cost.to_i}k):", @team.rerolls, "Cheerleaders", @team.cheerleaders],
