...
blitzer = underworld.positions.create(:name => "Skaven Blitzer",
  ...
  :normal_skills => ["general", "strength", "mutation"], :double_skills => ["passing", "agility", "mutation"],
  :cost => 90, :journeyman_position => false, :maximum => 2)
thrower = underworld.positions.create(:name => "Skaven Thrower",
  :mv => 7, :st => 3, :ag => 3, :av => 7,
  :normal_skills => ["general", "passing", "mutation"], :double_skills => ["strength", "agility", "mutation"],
  :default_skills => ["Pass, Sure Hands"], :maximum => 2,:cost => 70)
lineman = underworld.positions.create(:name => "Skaven Lineman",
  :mv => 7, :st => 3, :ag => 3, :av => 7, 
  :default_skills => [],
  :normal_skills => ["general", "mutation"], :double_skills => ["strength", "passing", "agility", "mutation"],
  :maximum => 2,:cost => 50)
goblin = underworld.positions.create(:name => "Underworld Goblin",
  :mv => 6, :st => 2, :ag => 3, :av => 7, 
  :default_skills => ["Dodge", "Stunty"],
  :normal_skills => ["agility", "mutation"], :double_skills => ["strength", "passing", "mutation", "general"],
